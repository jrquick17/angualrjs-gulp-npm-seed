...
(function () {
  ...
  PricingService.$inject = ['$q'];

  function PricingService($q) {
    ...
    function getPlans() {
      var plans = [{
        ...
        num_of_users: 10,
        gigabytes: 10,
        additional: ['Email support', 'Help center access'],
        ...
        num_of_users: 20,
        gigabytes: 10,
        additional: ['Priority email support', 'Help center access'],
        ...
        num_of_users: 30,
        gigabytes: 15,
        additional: ['Phone and email support', 'Help center access'],
...
(function () {
  ...
  PricingController.$inject = ['PricingService'];

  function PricingController(PricingService) {
    var PricingController = this;
    PricingController.loadPlans = loadPlans;

    function loadPlans() {
      return PricingService.getPlans().then(function (plans) {
        if (plans) {
...
(function () {
  ...
  angular.module('myApp').controller('PlanController', PlanController);
...
(function () {
  ...
  angular.module('myApp').directive('plan', plan);
